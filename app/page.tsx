  ...
  return <main>
    ...
    <section className="app-shell">
      ...
      <div className="content">
        ...
        {tab === "rutas" && routeAuditors.length > 0 && <RoutePreview auditors={routeAuditors} rows={routeRows}/>}
